...
// referee across however many seasons of history this pipeline has loaded. It's a real, computed number, though
// it's only ever as good as the sample size, so `gamesCalled` is always surfaced alongside it.
//
