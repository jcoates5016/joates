...
export const RISK_TIERS = [
  { key: "low", label: "Low Risk", minProb: impliedFromAmerican(-200), maxProb: 1.01, legs: 3,
    desc: "3 legs, each -200 or safer by our model's real probability — the closest thing this board has to a sure thing." },
  { key: "medium", label: "Medium Risk", minProb: impliedFromAmerican(-150), maxProb: impliedFromAmerican(-200), legs: 4,
    desc: "4 legs in the -150-to--200 range — still real favorites, just not the board's absolute safest plays." },
  { key: "high", label: "High Risk", minProb: 0.55, maxProb: impliedFromAmerican(-150), legs: 4,
    desc: "4 legs down at the board's real floor (55%+) — the riskiest legs this app will still call a real play, closest to plus money without ever crossing the 55% line." }
];
